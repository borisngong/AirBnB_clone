...
class HBNBCommand(cmd.Cmd):
    ...
    def do_show(self, line):
        """
        Displays the string representation of an instance specified by
    ...
    def do_update(self, line):
        """
        Updates the attributes of an instance specified by the class name,
        instance ID, attribute name, and new attribute value.
